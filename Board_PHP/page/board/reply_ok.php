...
<script type="text/javascript" src="/kks/assets/js/common.js"></script>
		...
		<div class="dap_lo">
			...
			<div class="dat_edit">
				<form method="post" action="rep_modify_ok.php">
					...
					<input type="submit" value="修正する" class="re_mo_bt">
				</form>
			</div>
			<!-- 댓글 삭제 비밀번호 확인 -->
			<div class='dat_delete'>
				<form action="reply_delete.php" method="post">
					<input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" /><input type="hidden" name="b_no" value="<?php echo $bno; ?>">
			 		<p>暗証番号<input type="password" name="pw" /> <input type="submit" value="確認"></p>
				 </form>
			</div>
		</div>
	<?php } ?>
	...
	<div class="dap_ins">
		<form method="post" class="reply_form">
			...
			<input type="password" name="dat_pw" id="dat_pw" size="15" placeholder="暗証番号">
			<div style="margin-top:10px;">
				<textarea name="content" class="reply_content" id="re_content" ></textarea>
				<button type="submit" id="rep_bt" class="re_bt">リプ</button>
			</div>
		</form>
	</div>
